...
const Updates = () => {
  ...
  function differenceBetweenTexts() {
    if(currentItems) {
      // old
    }
  }
    ...
    <Container title={"Update History"}>
      ...
      {currentItems?.map((item, i) => (
        <ul key={i}>
          ...
          <li>
            <p>
              <b>result:</b> {item.result ? item.result : "-"}
            </p>
          </li>
          <li>
            <p>
              <b>progress:</b> {item.progress ? item.progress : "-"}
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <b>packages_after:</b>{" "}
              {item.packages_after ? item.packages_after : "-"}
            </p>
          </li>
          <li>
            <p>
              <b>packages_diff:</b>{" "}
              {item.packages_diff ? item.packages_diff : "-"}
            </p>
          </li>
          <li>
            <p>
              <b>ansible_log:</b> {item.ansible_log ? item.ansible_log : "-"}
            </p>
          </li>
          <li>
            <p>
